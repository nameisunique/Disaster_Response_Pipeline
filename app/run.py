# run.py has been modified to calculate and display the Top 10 Categories
# It will use the model created in the Classifier script to predict how a new message should be classified
...
def index():
    ...
    # Count for the Top 10 Categories
